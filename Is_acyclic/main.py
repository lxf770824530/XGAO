...
def arg_parse():
    ...
    # gnn模型“训练”阶段的参数设置
    parser.add_argument("--dataset", default = 'Is_Acyclic', help = "Set the datasets. (Is_Acyclic / BA-2Motif / Twitch_Egos / MUTAG)")
    ...
    parser.add_argument("--temperature", default=1.0, help="The initial temperature ")
